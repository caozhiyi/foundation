...
#define LOG_DEBUG_S LogStream(fdan::SingletonLogger::Instance().GetStreamParam(fdan::LL_DEBUG, __FILE__, __LINE__))
#define LOG_INFO_S  LogStream(fdan::SingletonLogger::Instance().GetStreamParam(fdan::LL_INFO, __FILE__, __LINE__))
#define LOG_WARN_S  LogStream(fdan::SingletonLogger::Instance().GetStreamParam(fdan::LL_WARN, __FILE__, __LINE__))
#define LOG_ERROR_S LogStream(fdan::SingletonLogger::Instance().GetStreamParam(fdan::LL_ERROR, __FILE__, __LINE__))
#define LOG_FATAL_S LogStream(fdan::SingletonLogger::Instance().GetStreamParam(fdan::LL_FATAL, __FILE__, __LINE__))
