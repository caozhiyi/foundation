...
#ifndef FOUNDATION_ALLOTER_ALLOTER_INTERFACE_H_
#define FOUNDATION_ALLOTER_ALLOTER_INTERFACE_H_
...
class AlloterWrap {
 public:
  explicit AlloterWrap(std::shared_ptr<Alloter> a) : _alloter(a) {}
  ~AlloterWrap() {}
...
T* AlloterWrap::PoolMalloc(uint32_t sz) {
  return static_cast<T*>(_alloter->MallocAlign(sz));
}
...
#endif  // FOUNDATION_ALLOTER_ALLOTER_INTERFACE_H_
